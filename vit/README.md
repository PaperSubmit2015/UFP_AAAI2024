...
### 2. Train Model
```
python3 vit.py --name vitb32  --img_size 384  \
               --train_batch_size 256 --eval_every 500  --num_steps 20000 \
               --output_dir  ./logs   --dataset imagenet  \
               --model_type ViT-B_16 --pretrained_dir checkpoint/ViT-B_16.npz \
               --statInterval  500 \
               --qconf   vitufp.json
```

We provide 3 configuration scripts (vitfp32.json, viteci.json, vitufp.json) for FP32, FP8, and UFP FQT. You can replace the --qconf parameter to enable corresponding FQT mode.
